...
export function AgendaCalendarView() {
  ...
  return (
    <div className="flex flex-col h-full gap-4 mt-8 pt-8 border-t">
      <div className="flex flex-col gap-1 mb-2">
        <h2 className="text-2xl font-bold tracking-tight">Calendário Completo</h2>
        <p className="text-muted-foreground">
          Visão detalhada e gerenciamento de disponibilidade de horários.
        </p>
      </div>
